...
addToCartButtons.forEach(button => {
  button.addEventListener('click', function(e) {
    ...
    const productPages = productCard.querySelector('.book-overlay .pages').textContent;
...
function showNotification(message) {
  ...
  notification.innerHTML = `
    ...
    <div>
      <div style="font-weight: 700; margin-bottom: 3px;">Book Added!</div>
...
sortDropdown.addEventListener('change', function() {
  ...
  visibleProducts.sort((a, b) => {
    ...
    } else if (sortValue.includes('Title A-Z')) {
...
const stringBooks = document.querySelectorAll('[data-category="strings"]').length;
const windBooks = document.querySelectorAll('[data-category="winds"]').length;
const brassBooks = document.querySelectorAll('[data-category="brass"]').length;

console.log('Books page loaded successfully!');
console.log(`Total books: ${productCards.length}`);
console.log(`Strings: ${stringBooks}, Winds: ${windBooks}, Brass: ${brassBooks}`);